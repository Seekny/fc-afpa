...
class News
{
    ...
    public function getupdatedAtNews(): ?\DateTimeInterface
    {
        return $this->updatedAtNews;
    }

    public function setupdatedAtNews(\DateTimeInterface $updatedAtNews): self
    {
        $this->updatedAtNews = $updatedAtNews;
    ...
    public function __construct()
    {
        ...
        $this->updatedAtNews = new \DateTime();
    }
    ...
    public function setImageFile(?File $imageFile = null): void
    {
        ...
        if (null !== $imageFile) {
            ...
            $this->updatedAtNews = new \DateTimeImmutable();
        }
    }
