! function(t) {
    ...
    function i(i) {
        ...
        if (o.length && !(e.scrollTop() < 0))
            for (var a, r, h, p, c = e.scrollTop(), l = s.height(), d = e.height(), u = l - d, m = c > u ? u - c : 0, f = 0; f < o.length; f++)
                if (p = o[f], p.element.is(":visible") && !p.animate) {
                    if (p.check()) {
                        if (p.top < 0 ? a = 0 : (h = p.element.outerHeight(), a = l - h - p.top - p.options.bottom - c - m, a = 0 > a ? a + p.top : p.top), p.boundary && p.boundary.length) {
    ...
    return t.component("sticky", {
        ...
        init: function() {
            ...
            this.wrapper = this.element.wrap('<div class="uk-sticky-placeholder"></div>').parent(), this.computeWrapper(), this.element.css("margin", 0), a && (a === !0 || "!" === a[0] ? (a = a === !0 ? this.wrapper.parent() : this.wrapper.closest(a.substr(1)), i = !0) : "string" == typeof a && (a = t.$(a))), this.sticky = {
                self: this,
